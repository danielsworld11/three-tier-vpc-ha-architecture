...
# ---------- NAT gateways: one per AZ for real HA ----------
...
# Each private app subnet routes out through the NAT gateway in its own AZ
...
# DB subnets: no internet route at all, only local VPC traffic
